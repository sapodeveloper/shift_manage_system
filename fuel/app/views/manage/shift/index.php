	...
	<tbody>
		<?php foreach($irregular_shifts as $irregular_shift): ?>
			<tr class="<?php Helper_Shift_Irregular::shift_condition_color($irregular_shift->irregular_condition); ?>">
				...
				<td><?php echo Html::anchor('manage/shift/delete2/'.$irregular_shift->id, '<i class="fa fa-trash-o"></i>&nbsp;削除', array('class' => 'uk-button uk-danger', 'onclick' => "return confirm('削除します。よろしいですか？')")); ?></td>
			</tr>
		<?php endforeach; ?>
	</tbody>
</table>
