		...
		if (in_array('Simpleauth', $drivers))
		{
			...
			if ( ! \DBUtil::table_exists($table))
			{
				...
				\DBUtil::create_table($table, array(
					...
					'auth_id' => array('type' => 'int', 'constraint' => 11, 'default' => 1),
			...
			if ( ! \DBUtil::table_exists($table))
			{
				...
				if ( ! \DBUtil::table_exists($simpletable))
				{
					...
					\DBUtil::create_table($table, array(
						'id' => array('type' => 'int', 'constraint' => 11, 'auto_increment' => true),
						'username' => array('type' => 'varchar', 'constraint' => 50),
						'full_name' => array('type' => 'varchar', 'constraint' => 20),
						'frist_name' => array('type' => 'varchar', 'constraint' => 20),
						'last_name' => array('type' => 'varchar', 'constraint' => 20),
						'password' => array('type' => 'varchar', 'constraint' => 255),
						'department_id' => array('type' => 'int', 'constraint' => 11),
						'cource_id' => array('type' => 'int', 'constraint' => 11),
						'email' => array('type' => 'varchar', 'constraint' => 255),
						'year' => array('type' => 'int', 'constraint' => 11),
						'condition' => array('type' => 'int', 'constraint' => 1, 'default' => 1),
						'auth_id' => array('type' => 'int', 'constraint' => 11, 'default' => 1),
